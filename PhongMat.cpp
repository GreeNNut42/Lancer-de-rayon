...
PhongMat::PhongMat(glm::vec3 col, float a, float d, float s, float t, float m, float r, float f)
{
	color = col;
	ka = a;
	kd = d;
...
glm::vec3 PhongMat::getColor(Intersection *I, Scene *S, const Rayon *R, int current)
{
...
glm::vec3 PhongMat::shadows(glm::vec3 color, glm::vec3 pt, Scene *s, Intersection *I)
{
